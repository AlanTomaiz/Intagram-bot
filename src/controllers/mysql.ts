...
UPDATE metrics
SET attempts = attempts + 1, not_existent = not_existent + 1
WHERE metric_id = 1;
    `;
  }
...
UPDATE metrics
SET attempts = attempts + 1, pass_incorrect = pass_incorrect + 1
WHERE metric_id = 1;
    `;
  }
...
UPDATE metrics
SET attempts = attempts + 1, checkpoint = checkpoint + 1
WHERE metric_id = 1;
    `;
  }
